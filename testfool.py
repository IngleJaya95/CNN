...
i = 9
step =100
n = 0 # which epochs model to be  loaded(remember it starts from 0)
...
pic = load_obj('./obj/ep'+str(n)+'.pkl')
pic2 = np.reshape(pic,[28,28])
TcorrectP = sess.run([predictedLabels],feed_dict={features:pic2})
print(TcorrectP)
